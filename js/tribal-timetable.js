...
$(function () {
    ...
    $.fn.resizeTimetable = function () {
        ...
        var daysWidth = jQuery('.tt-days', this).width() + ttDaysExtras + 1;  // + border
        ...
        var test = (timesHeight + jQuery('.tt-days', this).height());
        ...
        jQuery('.tt-time', this).each(function (i) {
            if (i < hours - 1) {
                ...
                $(this).width(widthLeft - 2 - parseInt($(this).css('padding-left')) - parseInt($(this).css('padding-right')) - parseInt($(this).css('border-left-width')) - parseInt($(this).css('border-right-width')));
            }
        });
